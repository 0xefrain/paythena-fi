    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              <h1 className="text-5xl font-bold mb-8">
                Decentralized Payroll System for Web3
              </h1>
              <p className="text-xl mb-8 opacity-80">
                Streamline your DAO or Web3 company payroll with automated USDe payments, yield generation, and salary-backed lending on Ethena Protocol.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="card bg-primary text-primary-content hover:scale-105 transition-transform duration-200">
              <div className="card-body items-center text-center">
                ...
                <h3 className="card-title text-2xl mb-2">For DAOs & Companies</h3>
                ...
                <ul className="text-left space-y-2 mb-6">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    Manage contributors efficiently
                  </li>
                  <li className="flex items-center gap-2">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    Generate yield on treasury
                  </li>
                </ul>
                <Link 
                  href="/register" 
            ...
            <div className="card bg-secondary text-secondary-content hover:scale-105 transition-transform duration-200">
              <div className="card-body items-center text-center">
                ...
                <h3 className="card-title text-2xl mb-2">For Contributors</h3>
                <div className="divider my-2"></div>
                <ul className="text-left space-y-2 mb-6">
                  <li className="flex items-center gap-2">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-200">
              <div className="card-body">
                ...
                <p>Generate yield on idle funds through Ethena protocol integration for both employers and contractors.</p>
              </div>
            </div>
            ...
            <div className="card bg-base-200">
              <div className="card-body">
                ...
                <p>Built on Ethena Protocol's robust infrastructure, ensuring institutional-grade security and reliability for all transactions and funds.</p>
              </div>
            </div>
            ...
            <div className="card bg-base-200">
              <div className="card-body">
                ...
                <p>Seamless integration with Ethena's USDe for stable and efficient payments.</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-base-200">
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          <p className="text-xl mb-8 opacity-80">
            Join the future of decentralized payroll management with Paythena.
          </p>
          <Link href="/register" className="btn btn-primary btn-lg">
      ...
      <footer className="footer footer-center p-10 bg-base-300 text-base-content">
        <div>
          ...
          <p className="font-bold">
            Paythena - Web3 Payroll Solutions
          </p>
